            ...
            child: PageView(
              ...
              children: [
                ...
                _buildPage(
                  ...
                  badges: [
                    _badgeItem("pfc", "assets/images/brainCard.png", "Reason"),
                    _badgeItem("amygdala", "assets/images/brainCard.png", "Emotions"),
                    _badgeItem("temporal", "assets/images/brainCard.png", "Language"),
                    _badgeItem("kleinhirn", "assets/images/brainCard.png", "Movement"),
                    _badgeItem("hippocampus", "assets/images/brainCard.png", "Memories"),
                  ],
                ),
                _buildPage(
                  title: "Mental Health",
                  ...
                  badges: [
                    _badgeItem("anxiety", "assets/images/brainThinking.png", "Courage"),
                    _badgeItem("adhs", "assets/images/brainThinking.png", "Focus"),
                    _badgeItem("depression", "assets/images/brainThinking.png", "Hope"),
                    _badgeItem("addiction", "assets/images/brainThinking.png", "Freedom"),
                    _badgeItem("trauma", "assets/images/brainThinking.png", "Healing"),
                  ],
                ),
              ],
            ),
      ...
      children: [
        ColorFiltered(
          ...
          child: Opacity(
            ...
            child: Image.asset(imagePath, height: 60, errorBuilder: (c, o, s) => const Icon(Icons.lock, size: 40)),
          ),
        ),
